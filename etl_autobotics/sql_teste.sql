...
INSERT INTO controlador (modelo, numero_serial, status, fk_empresa, fk_setor)
VALUES
('Modelo-X', 'COD000', 'ativo', 1, 1),
('Modelo-X', 'COD001', 'ativo', 1, 1),
('Modelo-X', 'COD002', 'ativo', 1, 1),
('Modelo-X', 'COD003', 'ativo', 1, 1),
('Modelo-X', 'COD004', 'ativo', 1, 1),
('Modelo-X', 'COD005', 'ativo', 1, 1);
